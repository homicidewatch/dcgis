...
DATABASES = {
    'default': {
        ...
        'NAME': 'dcgis',                      # Or path to database file if using sqlite3.
...
SECRET_KEY = 'w=wha_c2i)r%+lkrni+y2^3*d*zo^b4b!50rg@0k+v(8)9=f+1'
...
LOGGING = {
    ...
    'loggers': {
        ...
        'boundaryservice.load_shapefiles': {
            'handlers': ['console'],
            'level': 'INFO',
            'formatter': 'simple'
        }
